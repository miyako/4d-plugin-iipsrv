...
std::string TileManager::getIndex( int resolution, int tile, int xangle, int yangle, int layers, CompressionType c ){
	
	return tileCache->getIndex(image->getImagePath(),
														 resolution,
														 tile,
														 xangle,
														 yangle,
...
std::string TileManager::getRegionIndex( unsigned int res, int seq, int ang, int layers, unsigned int x, unsigned int y, unsigned int width, unsigned int height ){
	
	return tileCache->getRegionIndex(image->getImagePath(),
																	 res,
																	 seq,
																	 ang,
																	 layers,
